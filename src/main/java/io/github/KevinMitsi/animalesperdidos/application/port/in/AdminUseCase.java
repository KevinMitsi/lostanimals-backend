...
public interface AdminUseCase {
    ...
    CompletionStage<Void> setServiceArea(UUID adminId, String municipalityCode, boolean enabled);
    CompletionStage<Void> changeRole(UUID adminId, UUID userId, UserRole role);
    record ServiceAreaView(String municipalityCode, boolean enabled) { }
}
